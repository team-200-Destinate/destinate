...
function ContactInfo() {
  return (
    <section className="contact-info pt-14 ">
      <section className="py-10 sm:py-16 lg:py-24 ">
    <div className="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl py-10 rounded-3xl bg-gray-100">
        <div className="max-w-2xl mx-auto text-center">
            <h2 className="text-3xl font-bold leading-tight text-gray-900 sm:text-4xl lg:text-5xl top-20 ">Contact us</h2>
